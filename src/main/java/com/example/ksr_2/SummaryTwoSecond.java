...
public class SummaryTwoSecond {
    ...
    public SummaryTwoSecond(Quantifier quantifier, List<Label> qualifiers, List<Label> summarizers, List<FoodEntry> objects1, List<FoodEntry> objects2) {
    ...
    public double calculateInclusionLukasiewicz(List<Double> A, List<Double> B) {
        double sumImplication = 0.0;
